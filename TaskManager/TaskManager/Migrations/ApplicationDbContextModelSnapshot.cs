...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManager.Model.Domain.Project", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 7, 31, 19, 22, 25, 763, DateTimeKind.Local).AddTicks(2413),
                            Name = "SpendSmart",
                            StartDate = new DateTime(2023, 7, 31, 19, 22, 25, 763, DateTimeKind.Local).AddTicks(2400),
                            UserId = 0
                        },
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 7, 31, 19, 22, 25, 763, DateTimeKind.Local).AddTicks(2420),
                            Name = "FoodBuddy",
                            StartDate = new DateTime(2023, 7, 31, 19, 22, 25, 763, DateTimeKind.Local).AddTicks(2420),
                            UserId = 0
                        },
                        new
                        {
                            ...
                            EndDate = new DateTime(2023, 7, 31, 19, 22, 25, 763, DateTimeKind.Local).AddTicks(2422),
                            Name = "PolicyBazar",
                            StartDate = new DateTime(2023, 7, 31, 19, 22, 25, 763, DateTimeKind.Local).AddTicks(2422),
                            UserId = 0
                        });
                });
            ...
            modelBuilder.Entity("TaskManager.Model.Domain.Tasks", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DueDate = new DateTime(2023, 7, 31, 0, 0, 0, 0, DateTimeKind.Local),
                            ProjectId = 1,
                            Status = true,
            ...
            modelBuilder.Entity("TaskManager.Model.Domain.Project", b =>
                {
                    b.HasOne("TaskManager.Model.Domain.User", "User")
                        .WithOne("Project")
                        .HasForeignKey("TaskManager.Model.Domain.Project", "UserId")
